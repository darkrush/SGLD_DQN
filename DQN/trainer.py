...
class DQN_trainer(object):
    ...
    def train(self):
        #50_epoch * 1000_cycle * 250_iter * 4_step
        all_steps = self.nb_epoch*self.nb_cycles_per_epoch*self.nb_iter_steps*self.nb_rollout_steps
        for epoch in range(self.nb_epoch):
            ...
            for cycle in range(self.nb_cycles_per_epoch):
                ...
                print("{} | {} current step {:>8d}/{:<8d}".format(self.name,localtime,self.total_step,all_steps))
            ...
            Singleton_evaluator.trigger_eval_process(total_step = self.total_step)
            Singleton_logger.trigger_save()
