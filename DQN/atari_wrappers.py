...
def make_atari(env_id, max_episode_steps=None, monitor = False,dir = None):
    env = gym.make(env_id)
...
def wrap_deepmind(env, episode_life=True, clip_rewards=True, frame_stack=False, scale=False, pytorch_img = True):
